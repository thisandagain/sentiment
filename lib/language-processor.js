...
const frLanguage = require("../languages/fr/index");

// Add emojis
Object.assign(enLanguage.labels, emojis);
Object.assign(frLanguage.labels, emojis);
...
module.exports = {
  ...
  getLanguage: function(languageCode) {
    ...
    if (!languages[languageCode]) {
      ...
      try {
        ...
        let language = require("../languages/" + languageCode + "/index");
  ...
  applyScoringStrategy: function(languageCode, tokens, cursor, tokenScore) {
    ...
    // eslint-disable-next-line max-len
    let scoringStrategy = language.scoringStrategy || defaultScoringStrategy;
    return scoringStrategy.apply(tokens, cursor, tokenScore);
  }
};

let defaultScoringStrategy = {
